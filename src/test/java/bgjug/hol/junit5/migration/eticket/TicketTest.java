...
public class TicketTest {
    ...
    public void recentlyBoughtTicket_isValid() {
        Ticket ticket = new Ticket("code", AN_HOUR_AGO);
    ...
    public void futureTicket_isNotValid() {
        Ticket ticket = new Ticket("code", FUTURE);
    ...
    public void moreThanTwoYears_isNotValid() {
        Ticket ticket = new Ticket("code", MORE_THEN_TWO_YEARS);
    ...
    public void twoYearOldOldTicket_isValid() {
        Ticket ticket = new Ticket("code", TWO_YEAR_OLD);
